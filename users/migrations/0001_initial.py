# Generated by Django 5.1.7 on 2025-03-09 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filiere', models.CharField(choices=[('CNM', 'CNM'), ('RSS', 'RSS'), ('DSI', 'DSI')], max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='PlageHoraire',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('etudiant', 'etudiant'), ('admin', 'admin'), ('directeur', 'directeur'), ('comiteur', 'comiteur')], default='etudiant', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matieres', models.ManyToManyField(to='users.matiere')),
            ],
        ),
        migrations.CreateModel(
            name='JourSemaine',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('groupe_enfant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupe_parent', to='users.groupe')),
                ('groupe_parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sous_groupes', to='users.groupe')),
            ],
        ),
        migrations.CreateModel(
